...
txt_stopword = pd.read_csv("D:/O2122121 Adms/Kuliah/Project Flask/Sentiment Analysis Using Model LSTM& Neural Network/library/stopwords.txt", names= ["stopwords"], header = None)
...
normalisasi = pd.read_csv("D:/O2122121 Adms/Kuliah/Project Flask/Sentiment Analysis Using Model LSTM& Neural Network/library/kamusalay.csv",encoding='utf-8')
normalisasi_dict = {}
